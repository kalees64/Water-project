                    ...
                    <ScrollView>
                        <View style={{ gap: 5 }}>
                            ...
                            >
                                ...
                                >
                                    <Iconify icon="uil:package" size={25} color="#2B3674" />
                                </View>
                                <Text
                                    style={{
                                        color: "#2B3674",
                    ...
                    >
                        <View style={{ display: "flex", flexDirection: "row" }}>
                            ...
                            <View>
                                ...
                                >
                                    Manage Vendors/Today Orders/ Order Details
                                </Text>
                            </View>
                        </View>
                                    ...
                                    >
                                        <View style={{ width: "34%", padding: 10 }}>
                                            <Image
                                                ...
                                                source={require("../../assets/images/20_litre.png")}
                                            />
                                        </View>
                                        <View
                                            style={{
                            ...
                            <View style={{ width: "50%" }}>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <View>
                                            <Image
                                                style={{ color: "#2b3674" }}
                                                source={require("../../assets/images/line2.jpg")}
                                            />
                                        </View>
                                        <View>
                                            <Iconify
                                ...
                                >
                                    ...
                                    <View style={{ gap: 5 }}>
                                        ...
                                        >
                                            2/E Samathanapuram, Tirunelveli, Tamilnadu -
                                        </Text>
                                        <Text
                                            style={{
                                                fontSize: 16,
