  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text style={{ fontWeight: "bold", fontSize: 25 }}>Other Banks</Text>
        </View>
        ...
        >
          ...
          >
            <View style={{ width: "15%" }}>
              <Icon8 name="bank" size={25} color="#0e6fac" />
            </View>
            <TextInput placeholder="Search Your Bank" style={{ height: 35 }} />
          </View>
          <Icon9
            name="search"
            size={25}
        ...
        <View style={{ width: "100%", padding: 20 }}>
          ...
          >
            ...
            >
              <View style={{ width: "15%" }}>
                <Image
                  source={require("../assets/images/hdfc_icon.png")}
