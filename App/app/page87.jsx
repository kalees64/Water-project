            ...
            <ScrollView>
                ...
                <View >
                    <View style={{ display: 'flex', flexDirection: 'row', marginTop: 20, marginLeft: 17 }} >
                        ...
                        <Text style={{ fontSize: 22, fontWeight: "bold", }}>Edit Review</Text>
                    </View>
                ...
                <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingTop: 10, }}>
                    <Icon9 name='star' size={20} style={{ color: '#FFA500' }}></Icon9>
                    <Icon9 name='star' size={20} style={{ color: '#FFA500' }}></Icon9>
                    <Icon9 name='star' size={20} style={{ color: '#FFA500' }}></Icon9>
                    <Icon9 name='star' size={20} style={{ color: '#FFA500' }}></Icon9>
                    <Icon9 name='star-o' size={20}></Icon9>
                ...
                <View style={{ gap: 25, paddingTop: 20, padding: 20, }}>
                    <Text style={{
                        ...
                        display: 'flex',
                        flexDirection: 'row',
                        justifyContent: 'space-between', borderColor: "#aeaeae", borderWidth: 1, height: 115, shadowColor: '#aeaeae', shadowOffset: { width: 2, height: 2, }, borderRadius: 10, padding: 10,
                    }}>   Fantastic service! The delivery was right on time, and the quality of water is exceptional. I love the convenience of scheduling deliveries through the app.</Text>

                </View>
                <View style={{ width: '100%', padding: 20, }}>
                    <Text style={{ width: '100%', textAlign: 'center', shadowColor: '#b3b3b3', shadowOffset: { width: 2, height: 2 }, color: "white", borderRadius: 8, fontSize: 15, backgroundColor: "#3fbdf1", padding: 10, paddingRight: 10, }}>Save Review</Text>
                </View>
